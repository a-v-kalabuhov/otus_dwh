...
1. Подключил ClickHouse к Superset.
...
На занятии "Создание метрик и дашбордов" Алексй Железной задал вопрос: Почему не изменяются распространённые наборы метрик, хотя они моги уже и устареть?

Написал небольшой документ с ответом на этот вопрос. Скачать его можно: [здесь](./Метрики.docx)
