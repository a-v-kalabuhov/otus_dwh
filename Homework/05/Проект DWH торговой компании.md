...
2. Детализации данных до уровня одного дня.
...
1. Данные о продажах розничной сети и интернет-магазина храняться в базе 1С Торговля. Для выгрузки в DWH используется веб-сервис 1С.
    Формат данных: JSON.
...
5. Магазин - место продажи *товаров*. Магазины - розничные и есть интернет-магазина один на все регионы. Магазины деолятся по *типам* - премиальные, стандартные и дискаунтеры. Отдельными типоми можно добавить интернет-магазин и маркетплейсы.
...
Сущности товар, производитель, бренд, номенклатурная группа, магазин, тип магазина, клиент, маркетинговая акция, регион являебся измерениями.
Дополнительное измерение для хранения дат.
...
|Позиция заказа|STG_|FACT_ORDERS_PRODUCTS|
